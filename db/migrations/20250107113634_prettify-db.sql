...
ALTER TABLE "collection_likes" RENAME COLUMN "list_id" TO "collection_id";
...
ALTER TABLE "list_like" RENAME COLUMN "collection_id" TO "list_id";
ALTER TABLE "favorite_list" RENAME COLUMN "collection_id" TO "list_id";
ALTER TABLE "review" RENAME COLUMN "collection_id" TO "list_id";
