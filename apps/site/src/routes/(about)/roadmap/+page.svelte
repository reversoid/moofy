...
<Wrapper>
	...
	<p class="text-muted-foreground mt-4">
		Мы постоянно работаем над улучшением нашего сервиса и добавлением новых функций.
		<br /> Здесь вы можете узнать о том, что мы планируем добавить в будущем.
	</p>
